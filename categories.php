...
//send user back to login page if user is not logged in yet
...
<html lang="en">
  ...
  <body>
    ...
    <?php
            ...
            //get category id from every tab
            $category_id = $_POST['category'];
            
            //select all products from database with the same category id and product quantity is greater than 0
            $getProd = "SELECT * from products WHERE category_id = $category_id and prodQty > 0";
            $runProd= mysqli_query($conn,$getProd);
            
            //fetch all the products with the same prodId and display them
